...
class PledgeDetailCollector(BaseTushareCollector):
    ...
    def store_raw(self, records: list[dict]) -> int:
        return self._store_dedup(RawPledgeDetail, records, ["ts_code", "ann_date", "holder_name"])
    ...
    def run(self, **kwargs) -> dict:
        ...
        try:
            ...
            result = nas_duckdb.query("SELECT DISTINCT ts_code FROM raw_pledge_detail WHERE ts_code IS NOT NULL")
